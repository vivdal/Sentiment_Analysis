...
peg_train_accuracy, peg_test_accuracy = p1.classifier_accuracy(p1.pegasos, train_bow_features,test_bow_features, train_labels,
                                                                       test_labels, T=T, L=L)
print("Best_training_accuracy_pegasos:", peg_train_accuracy)
print("Best_testing_accuracy_pegasos:", peg_test_accuracy)
